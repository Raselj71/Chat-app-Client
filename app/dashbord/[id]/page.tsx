    ...
    <section className="bg-cyan-700 h-full relative ">
      <div className="flex w-full  bg-gray-800 border-l-2 items-center px-4">
        ...
        <p className="text-left text-4xl py-2 w-full  ml-4">{receiver}</p>
         <form >
             <input className="bg-slate-700 h-10 w-[30rem] outline-none border-b mr-5 px-4 rounded-sm" type="search" name="search" id="search" placeholder="Search your message" onChange={handleSearch} value={searchQuery}/>
         </form>
